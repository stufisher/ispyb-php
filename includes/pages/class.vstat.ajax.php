<?php
    ...
    class Ajax extends AjaxBase {
        ...
        var $dispatch = array('breakdown' => '_visit_breakdown',
                              'pies' => '_pies',
                              'hrs' => '_hourlies',
                              'ehc' => '_ehc_log',
                              'call' => '_callouts',
        ...
        function _visit_breakdown() {
            ...
            $dc = $this->db->pq("SELECT dc.datacollectionid as id, TO_CHAR(dc.starttime, 'DD-MM-YYYY HH24:MI:SS') as st, TO_CHAR(dc.endtime, 'DD-MM-YYYY HH24:MI:SS') as en, (dc.endtime - dc.starttime)*86400 as dctime, dc.runstatus FROM ispyb4a_db.datacollection dc WHERE dc.sessionid=:1 ORDER BY dc.starttime DESC", array($info['SID']));
        ...
        function _pies() {
            ...
            #if ($this->has_arg('visit')) {
            #    $dc[0]['NOBEAM'] = $total_no_beam/3600;
            #}
