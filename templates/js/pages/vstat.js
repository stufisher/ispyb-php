$(function() {
  ...
  plot()
    ...
    return "<div style='font-size:6pt; text-align:center; padding:2px; color:white;width: 50px'>" + label + "<br/>" + Math.round(series.percent) + "%</div>";
    }
  
    $.plot('#pie1', pie_data['mx'], pieops);
    $.plot('#pie2', pie_data['in'], pieops);
    $.plot('#pie3', pie_data['sw'], pieops);
});
